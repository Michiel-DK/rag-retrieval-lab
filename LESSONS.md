...
| zerank-1-small (1.7B cross-encoder) vs dense | nDCG@10 +0.0714, CI [+0.055, +0.089], p ≈ 0 | most of the LLM's gain at zero marginal cost | an off-the-shelf cross-encoder captures ~80% of the LLM-judge lift; the LLM's edge is real but pay-per-query |
